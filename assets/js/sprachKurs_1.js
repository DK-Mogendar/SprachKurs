...
function validateRadio() {                                      //funktion mit der Klasse validateRadio defiert:
    ...
    if (!( radioElementHtml.checked || radioElementCss.checked || radioElementJs)) { //ist kein radioElementHtml (ect.) vorhanden dann:
        // Fehlerfall
        setMessage1('Bitte wähle eine Programmiersprache aus. Dankeschön.');         // Giebt eine Nachricht aus Text ...
        return false;                                                                // ist falsch

    }
    else {                                                                           //oder
        // Erfolgsfall
        let radioButtons = document.getElementsByHtml("radio-mood");
        let value;
        ...
        setMessage1('Du hast "' + value + '" gewählt'); //sede die nachricht Text+value+Text
